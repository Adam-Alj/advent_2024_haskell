...
lineValid (target, numbers) =
    isEquationPossiblyValid target 0 numbers (+) || isEquationPossiblyValid target 1 numbers (*)
...
isEquationPossiblyValid target total numbers operation
    ...
    | total > target = False
    | otherwise = isEquationPossiblyValid target (total `operation` head numbers) (tail numbers) (+) || isEquationPossiblyValid target (total `operation` head numbers) (tail numbers) (*)
